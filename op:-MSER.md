...
#### Model
If `"detect":"keypoints"` is specified, a KeyPoint model is generated for the stage for each MSER region detected. The following model corresponds with the _MSER with keypoints_ example below:
<pre>
 "mser":{
    "keypoints":[
      {
